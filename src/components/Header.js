...
import logo from '../images/logo-pwn.svg';
import '../styles/Header.css'
import {NavLink, withRouter} from "react-router-dom";
import {getDevice, Devices, classSet, favouritesEnabled} from './utils';


const taverneLat = 46.580774;
const taverneLon = 0.341807;
...
class _Header extends Component {
    ...
    render() {
        ...
        let goToUrl = `https://www.google.com/maps/dir/?api=1&destination=${taverneLat},${taverneLon}`;
        if (device && device === Devices.ios) {
            goToUrl = `http://maps.apple.com/?daddr=${taverneLat},${taverneLon}&dirflg=d`
        } else if (device && device === Devices.android) {
            goToUrl = `google.navigation:q=${taverneLat},${taverneLon}`
        }
            ...
            <nav>
                <div className="nav-wrapper">
                    ...
                    <div className="brand-logo right">
                        <span className="brand-title">poitiers web nerdz</span>
                        ...
                        <img src={logo} onClick={this.goToProgram} id="jug" className={classSet({"jug-logo": true, "offline": !navigator.onLine})} alt="PWN"/>
